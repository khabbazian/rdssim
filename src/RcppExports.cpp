...
// rdssim_cpp
Rcpp::NumericMatrix rdssim_cpp(Rcpp::List rcpp_adjlist, std::string rType, bool wReplacement, int nSamples, int nReferrals, int seedNode, int rseed);
RcppExport SEXP rdssim_rdssim_cpp(SEXP rcpp_adjlistSEXP, SEXP rTypeSEXP, SEXP wReplacementSEXP, SEXP nSamplesSEXP, SEXP nReferralsSEXP, SEXP seedNodeSEXP, SEXP rseedSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    __result = Rcpp::wrap(rdssim_cpp(rcpp_adjlist, rType, wReplacement, nSamples, nReferrals, seedNode, rseed));
    return __result;
END_RCPP
}
